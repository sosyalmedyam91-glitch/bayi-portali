    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-[#53575A]">Ürün stok durumlarını izleyin, güncelleyin ve kritik seviyeleri takip edin.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 bg-white border rounded-xl shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-[#53575A] font-medium">Toplam Benzersiz Ürün</p>
        ...
        <div className="p-4 bg-white border rounded-xl shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-[#53575A] font-medium">Kritik Stok Seviyesi</p>
        ...
        <div className="p-4 bg-white border rounded-xl shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-[#53575A] font-medium">Tükenen Ürünler</p>
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between bg-white p-4 border rounded-xl shadow-sm">
        ...
        <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 border rounded-lg text-sm font-medium text-[#53575A] bg-white hover:bg-gray-50 hover:text-gray-900 focus:ring-2 focus:ring-[rgba(234,0,41,0.15)] focus:border-[#EA0029] transition-all outline-none">
          {/* Ayar/Filtre İkonu */}
      ...
      <div className="bg-white border rounded-xl shadow-sm overflow-hidden">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100 text-[#53575A] text-xs font-semibold uppercase tracking-wider">
                ...
                <th className="py-3 px-4 flex items-center gap-1 cursor-pointer hover:text-gray-900 py-3 transition-colors">
                  Miktar 
                ...
                .map((stock) => (
                  <tr key={stock.id} className="hover:bg-gray-50/70 transition-colors">
                    <td className="py-3.5 px-4 font-mono text-xs">
                      <div className="font-semibold text-gray-900">{stock.id}</div>
                      <div className="text-gray-400">{stock.sku}</div>
                    </td>
                    <td className="py-3.5 px-4 font-medium text-gray-900">{stock.name}</td>
                    <td className="py-3.5 px-4 text-[#53575A]">{stock.category}</td>
                    ...
                    <td className="py-3.5 px-4 text-right">
                      <div className="flex justify-end gap-2">
                        {/* Düzenle Butonu */}
                        <button title="Düzenle" className="p-1.5 text-[#53575A] hover:text-[#EA0029] hover:bg-[rgba(234,0,41,0.06)] rounded-md transition-colors">
        ...
        <div className="p-4 border-t bg-gray-50/50 flex justify-between items-center text-xs text-[#53575A]">
          ...
          <div className="flex gap-2">
            <button className="px-3 py-1 border rounded bg-white text-[#53575A] hover:bg-gray-50 disabled:opacity-50 transition-colors" disabled>Önceki</button>
            <button className="px-3 py-1 border rounded bg-white text-[#53575A] hover:bg-gray-50 disabled:opacity-50 transition-colors" disabled>Sonraki</button>
          </div>
        </div>
      </div>
