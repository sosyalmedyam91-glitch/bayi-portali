    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Müşterilere sunulan fiyat tekliflerini hazırlayın, revizyonları takip edin ve onay süreçlerini yönetin.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 bg-white border rounded-xl shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm text-gray-500 font-medium">Bekleyen Teklifler</p>
        ...
        <div className="p-4 bg-white border rounded-xl shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm text-gray-500 font-medium">Bu Ay Onaylanan</p>
        ...
        <div className="p-4 bg-white border rounded-xl shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm text-gray-500 font-medium">Açık Potansiyel Hacim</p>
        ...
        <div className="p-4 bg-white border rounded-xl shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm text-gray-500 font-medium">Kazanma Oranı</p>
                ...
                .map((quote) => (
                  <tr key={quote.id} className="hover:bg-gray-50/70 transition-colors">
                    ...
                    <td className="py-3.5 px-4 font-mono text-xs text-gray-500">
                      <div className="font-semibold text-gray-700">{quote.id}</div>
                    ...
                    <td className="py-3.5 px-4 text-right">
                      <div className="flex justify-end gap-1">
                        ...
                        <button title="PDF Yazdır / Gönder" className="p-1.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors">
                        ...
                        <button title="Yeni Revizyon Oluştur" className="p-1.5 text-gray-500 hover:text-purple-600 hover:bg-purple-50 rounded-md transition-colors">
